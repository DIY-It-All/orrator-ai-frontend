  ...
  return (
    ...
    <div className="w-screen h-screen flex items-center align-center justify-center ">
      <div className="w-[90%] h-[90%] m-auto flex">
        <Image src="/image.jpg" slt="img" width={1920} height={1080} className="w-[40%] h-[100%] rounded-l-lg"/>
        <div className="bg-gray-800 grow items-center flex flex-col capitalize rounded-r-lg">
          ...
          <br />
          <h1 className="text-xl font-bold text-center py-2">Connect Your MetaMask Account</h1>
