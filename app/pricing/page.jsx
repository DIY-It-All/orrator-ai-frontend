        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p className="mb-5 font-light text-gray-500 sm:text-xl ">
              Here at Orator-AI we have plans that cater to all your needs. Choose between a monthly or yearly subscription and enjoy access to our top of the line services immediately.
            </p>
          </div>
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-purple-700 shadow ">
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                <li className="flex items-center space-x-3">
                  ...
                  <span>Access to an AI-powered presentation evaluator</span> 
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500 "
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>24x7 customer services</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500"
              ...
              {/* //TODO: Add the functions to subscribe to the plan */}
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-purple-700  shadow ">
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                <li className="flex items-center space-x-3">
                  ...
                  <span>Access to AI based presentation criticizer</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500 "
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>Priority AI requests</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500 "
                  ...
                  <span>Exclusive AI models for Premium members</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500"
